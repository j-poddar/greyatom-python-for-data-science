...
def compare_msg(message_d,message_e):
    ...
    #final_msg = ' '
    #final_msg = final_msg.joined(c_list)
...
# In case you want to erase the content of the file, uncomment the below 3 lines:
...
#print(secret_msg)
#print(final_path.read())

f1 = open(final_path,'r')
#print(f1.read()) #secret message is printed
print(secret_msg)
#open(secret_msg,'r')
#Code ends here
